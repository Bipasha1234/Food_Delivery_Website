...
import Restaurant from '../../../components/fewRestaurant';
...
const isLoggedIn = token && token.trim() !== "" && token !== "undefined";
  ...
  <div  onClick={() => handleProtectedClick("/delivo-eats/location")} className="flex items-center bg-white   rounded px-4 py-2 hover:shadow-md transition cursor-pointer">
    <FaMapMarkerAlt className="text-orange-500 mr-2 text-sm" />
    <div className="text-sm text-gray-700">
      {/* <span className="block text-xs text-gray-500">Current Location</span> */}
      <span className="font-medium truncate">{shortAddress}</span>
        ...
        {/* Enhanced Image Slider with Search Bar */}
        <div className="relative w-full px-4 mt-1 flex items-center justify-center">
          <button
            onClick={handlePrev}
        ...
        <div className="mt-16 px-4">
          <Restaurant searchTerm={searchTerm} />
        </div>
